...
export const MOCK_OCCURRENCES: Occurrence[] = [
  {
    ...
    description: 'Grande foco de incêndio detectado no setor noroeste do parque. Risco de expansão elevado devido aos ventos.',
  ...
  },
  {
    ...
    description: 'Fogo de médio porte avançando em direção à reserva. Equipes em alerta.',
  ...
  },
  {
    ...
    description: 'Fumaça detectada por moradores na região rural. Aguardando confirmação.',
  ...
  },
  {
    ...
    description: 'Incêndio de grandes proporções atingindo área de cerrado nativo. Situação crítica.',
  ...
  },
  {
    ...
    description: 'Pequeno foco nas margens da BR-020. Sem risco imediato para áreas habitadas.',
...
export const SAFE_SHELTERS = [
  { id: '1', name: 'Escola Municipal João XXIII', distance: '2,3 km', address: 'Rua das Acácias, 450' },
  { id: '2', name: 'Ginásio Poliesportivo Central', distance: '3,8 km', address: 'Av. Principal, 1200' },
  { id: '3', name: 'Defesa Civil - Posto Regional', distance: '5,1 km', address: 'Setor Administrativo, Bloco C' },
];
