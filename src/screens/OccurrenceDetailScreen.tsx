    ...
    <SafeAreaView style={styles.container}>
      <View style={[styles.header, { backgroundColor: color }]}>
        ...
        <Text style={styles.urgencyBadge}>
          {URGENCY_LABEL[occurrence.urgency].toUpperCase()}
        </Text>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor: occurrence.firefightersDispatched
                ? "#1b5e2033"
                : "#b7000033",
            },
          ]}
        >
          <MaterialCommunityIcons
            name={
              occurrence.firefightersDispatched ? "fire-truck" : "timer-sand"
            }
            size={32}
          ...
          <View>
            <Text
              style={[
                ...
                {
                  color: occurrence.firefightersDispatched
                    ? "#1b5e20"
                    : "#b71c1c",
                },
              ]}
